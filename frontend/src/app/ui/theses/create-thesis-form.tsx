...
import { Student, Lecturer } from '@/app/lib/definitions';
...
export default function Form({
  ...
  const [state, action, isPending] = useActionState(createThesis, undefined);
  ...
  useEffect(() => {
    if (isPending) {
      ...
      if (state !== undefined) {
        if (state?.success) {
          toast.success('Tạo luận văn thành công!');
